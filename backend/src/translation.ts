...
- BIBLE REFERENCES: always render book names in Korean: John 3:16 → 요한복음 3장 16절; First Corinthians 13 → 고린도전서 13장; Psalm 23 → 시편 23편. Use the standard Korean book names (창세기, 시편, 마태복음, 요한계시록 ...), digits for the numbers, and 장/절 (시편 uses 편).
...
- NATURALNESS: the output must sound like a Korean pastor preaching, not like translated English. Restructure into natural Korean word order (verb last), render idioms and rhetorical questions by their natural Korean equivalents, and prefer phrasing a Korean pulpit would actually use. Faithfulness to the meaning still comes first — reshape the wording, never the message.
- If the segment is empty, meaningless, or pure filler, return {"translation": ""}.
- Your entire response must be the JSON object, starting with { and ending with }.`;
